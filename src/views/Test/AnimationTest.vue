...
<template>
  <div class="hello">
    <!-- card 1 -->
    <div data-aos="zoom-in" class="card" style="width: 18rem; margin: 100px auto">
      <img
    ...
    <!-- card  3-->
    <div data-aos="fade-right" class="card" style="max-width: 18rem; margin: 200px auto">
      <img
        src="https://images.unsplash.com/photo-1496171367470-9ed9a91ea931?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80"
        class="card-img-top"
        alt="..."
    ...
    <!-- card 4 -->
    <div data-aos="fade-left" class="card" style="width: 18rem; margin: 200px auto">
      <img
    ...
    <!-- card 5 -->
    <div data-aos="flip-left" class="card" style="width: 18rem; margin: 200px auto">
      <img
